...
- `RESEARCH_SYNTHESIS_2026-03-03.md`: primary synthesized guidance for `uc`.
- `CODEBASE_FINDINGS_2026-03-03.md`: verified technical findings from local code exploration.
- `DECISION_LOG_2026-03-03.md`: program-level architecture and delivery decisions.
